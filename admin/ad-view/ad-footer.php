...
<div class="fixed-plugin">
    ...
    <div class="card shadow-lg">
      ...
      <div class="card-body pt-sm-3 pt-0">
        <!-- Sidebar Backgrounds -->
        <div>
          <h6 class="mb-0">Màu thanh bên trái</h6>
        </div>
        ...
        <!-- Sidenav Type -->
        <div class="mt-3">
          <h6 class="mb-0">Kiểu thanh điều hướng bên trái</h6>
        </div>
        <div class="d-flex">
        ...
        <p class="text-sm d-xl-none d-block mt-2">Điều chỉnh thanh điều hướng theo kích thước thiết bị</p>
        <!-- Navbar Fixed -->
