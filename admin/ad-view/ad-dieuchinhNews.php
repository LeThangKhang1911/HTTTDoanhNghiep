<?php
  ...
  $dieuchinh = get_dieuchinh_news();
?>

<h3 style="text-align: center;">Danh sách các lần điều chỉnh/đăng tin tức</h3>
<table class="table" style="margin-top: 10px;">
  <thead>
    <tr>
      <th scope="col" style="text-align:center">ID</th>
      <th scope="col" style="text-align:center">ID tin tức được thêm/điều chỉnh</th>
  ...
  <tbody>
    ...
    ?>
        <tr>
            ...
            <td style="text-align:center"><?php echo $dc['idnews']; ?></td>
