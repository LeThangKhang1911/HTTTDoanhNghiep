<?php
    ...
    $dieuchinh = get_dieuchinh_slide();
?>

<h3 style="text-align: center;">Danh sách các lần điều chỉnh/thêm ảnh</h3>
<table class="table" style="margin-top: 10px;">
  <thead>
    <tr>
      <th scope="col" style="text-align:center">ID</th>
      <th scope="col" style="text-align:center">ID ảnh được thêm/điều chỉnh</th>
  ...
  <tbody>
    ...
    ?>
        <tr>
            ...
            <td style="text-align:center"><?php echo $dc['slideid']; ?></td>
