<?php
    ...
    if (isset($_POST['btn-addcanhdep'])) {
        ...
        $uploadDir = '../../../upload/image/canhdepchay/';
        ...
        add_canhdep($name, $imageName, $hide);
        $_SESSION['alert'] = [
...
<div class="form-container">
    <form action="ad-controller/HomeManage/add_canhdep.php" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <label for="name">Tên địa danh:</label>
        ...
        <div class="btn-container">
            <button type="submit" class="btn" name="btn-addcanhdep">Thêm ảnh</button>
